    ...
    where TOperation : IOperation
{
    ...
    public ValueTask Invoke( TOperation operation, CancellationToken cancellation );
}
    ...
    where TOperation : IOperation<TResult>
{
    ...
    /// <param name="operation"> The operation being invoked. </param>
    /// <param name="cancellation"> A token to trigger cancellation of the operation. </param>
    public ValueTask<TResult> Invoke( TOperation operation, CancellationToken cancellation );
}