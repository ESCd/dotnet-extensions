...
public static class ServiceProviderExtensions
{
    ...
    public static ValueTask<T> InvokeOperation<T>( this IServiceProvider serviceProvider, IOperation<T> operation, CancellationToken cancellation = default )
    {
    ...
    /// <param name="operation"> The operation to invoke. </param>
    /// <param name="cancellation"> A token to trigger cancellation of the operation. </param>
    public static ValueTask InvokeOperation( this IServiceProvider serviceProvider, IOperation operation, CancellationToken cancellation = default )
    {
        ArgumentNullException.ThrowIfNull( serviceProvider );
        ArgumentNullException.ThrowIfNull( operation );
